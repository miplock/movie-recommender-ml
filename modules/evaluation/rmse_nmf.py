...
def main() -> None:
    """Run bootstrap RMSE experiment for NMF configuration.

    EN:
    Builds evaluation config for NMF and delegates execution to the shared
    ...
    PL:
    Uruchamia eksperyment bootstrap RMSE dla konfiguracji NMF.

    Buduje konfigurację ewaluacji dla NMF i przekazuje wykonanie do
